from cviceni_5_jaccard import jaccardova_vzdalenost_mnozin
from cviceni_5_levenstein import levensteinova_vzdalenost2
...
def deduplikace_dotazu(dotazy):
    ...
    while i < len(dotazy):
        ...
        while j < len(dotazy):
            ...
            levenstein = levensteinova_vzdalenost2(dotaz1["dotaz"], dotaz2["dotaz"])
